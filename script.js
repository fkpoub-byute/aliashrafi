...
// Floating Skills Animation (Desktop Only)
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    resumeBtn.addEventListener("click", function (e) {
        e.preventDefault(); // جلوگیری از دانلود
...
const resetIdleTimer = () => {
    ...
    idleTimer = setTimeout(showIdleMessage, 20000); // 20 Seconds
};

['mousemove', 'touchstart', 'keydown', 'scroll'].forEach(evt =>
    window.addEventListener(evt, resetIdleTimer)
);
// --- 5. Playful CTA Response ---
...
if (ctaBtn) {
    ...
    const playfulTexts = [
        ...
        "یه پروژه خفن بسازیم ؟🚀",
        "Deploy کنیم؟ 😏",
        "404: ایده شما پیدا شد!",
        "یه commit جدید بزنیم؟",
        "بیاید اینترنت رو قشنگ‌تر کنیم 🎨",
        "Launch پروژه شروع شد 🚀",
        "یه ماجراجویی دیجیتال شروع کنیم",
        "قول میدم پروژه resolve بشه 😉"
    ];
